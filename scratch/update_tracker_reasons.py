...
print("=== UPDATING HISTORICAL TRACKER WITH EXPLICIT NO_BET REASONS ===")
...
for idx, item in enumerate(official_baseline_fights):
    ...
    print(f"[{idx+1:02d}] {f1_raw} vs {f2_raw} | VB: {is_value_bet} | Reason: {no_bet_reason} (EV max: {max_ev_pct:+.1f}% if available)")
...
print(f"\nSaved updated tracker data in data/historical_tracker.json")
